	...
	\section{Progettazione concettuale}
		...
		\subsubsection{Citt\`a - Cliente: ``Residenza"}
			...
			\subsubsection{Ticket-Cliente registrato: ``Apertura"}
				\paragraph{Molteplicit\`a N:1} Il cliente registrato pu\`o aprire pi\`u ticket, il ticket pu\`o essere aperto dal solo cliente interessato, relativo all'ordine effettuato.
				\paragraph{Totalit\`a: parziale verso Ticket / parziale verso Cliente registrato} Il cliente pu\`o non aprire un ticket, il ticket deve essere aperto dal solo cliente interessato.

	...
	\section{Progettazione concettuale}
		...
		\subsubsection{Citt\`a - Cliente: ``Residenza"}
			...
			\subsubsection{Ticket-Cliente registrato: ``Apertura"}
				...
				\paragraph{Totalit\`a: parziale verso Ticket / parziale verso Cliente registrato} Il cliente pu\`o non aprire un ticket, il ticket pu\`o non essere aperto dal cliente interessato.

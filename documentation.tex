	...
	\section{Progettazione concettuale}
		...
		\subsubsection{Citt\`a - Cliente: ``Residenza"}
			...
			\subsubsection{Ticket-Cliente registrato: ``Apertura"}
				\paragraph{Molteplicit\`a 1:N} Il ticket pu\`o essere aperto dal solo cliente interessato, relativo all'ordine effettuato; Il cliente registrato pu\`o aprire pi\`u ticket, i
...
\begin{center}
\hspace*{-1cm}
\includegraphics[scale=0.9]{query1.png}
\hspace*{-1cm}
\end{center}
